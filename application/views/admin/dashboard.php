    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="<?php echo base_url('admin/dashboard')?>" class="list-group-item"><i class="fa fa-dashboard"></i> Dashboard</a>
              ...
              <a href="<?php echo base_url() ?>/admin/dashboard/logout" class="list-group-item"><i class="fa fa-sign-out"></i> Logout</a>
            </div>
        </div>
        <div class="col-md-9">
